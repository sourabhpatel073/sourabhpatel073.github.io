    ...
    >
      ...
      >
        ...
        <Button
          ...
          size={["sm", "md"]}
          variant="none"
          bg="rgb(101, 39, 245);"  //Resume Button
          border="1px solid"
...
//        <Image width={"100%"} src={Logo}  borderRadius="10px"/>

//       </Box>
//       <Box>
//         <ScrollerLink smooth={true} duration={500} to="home">
//           Home
//         </ScrollerLink>

//         <ScrollerLink smooth={true} duration={500} to="skills">
//           Skills
//         </ScrollerLink>

//         <ScrollerLink smooth={true} duration={500} to="projects">
//           Projects
//         </ScrollerLink>

//         <ScrollerLink smooth={true} duration={500} to="contact">
//           Contact
//         </ScrollerLink>
//       </Box>
//     </Box>
